...
const WelcomePage: React.FC = () => (
  <WelcomeLayout>
      ...
      <div className="max-w-sm flex flex-col items-center mx-auto py-20 gap-10 md:max-w-md lg:max-w-lg lg:px-6">
        <div className="flex flex-col items-center gap-10 w-full lg:flex-row">
          ...
          <div className="w-full flex gap-6 md:hidden">
            ...
            <button className="w-full border-2 border-black text-black py-4 rounded-lg ">Já tenho conta</button>
          </div>
        </div>
    ...
    {/* <main className="w-full bg-gradient-to-b from-primary-color to-light">
      <div className="w-full max-w-sm mx-auto flex flex-col px-4 py-6 gap-6 md:max-w-md px-40 lg:max-w-lg">
        <div className="flex flex-col items-center gap-4 w-full lg:flex-row">
          <h1 className="text-black text-center font-semibold lg:w-full text-xl md:text-2xl">
